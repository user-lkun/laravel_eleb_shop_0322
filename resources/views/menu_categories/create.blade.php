...
@section('content_right')
    ...
    <form action="{{ route('menucategories.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal" style="width: 50%;margin: 50px auto">
        ...
        <div class="form-group">
            ...
            <div class="radio">
                <label>是 &emsp;&emsp;<input type="radio" name="is_selected" id="optionsRadios1" value="1">
                </label>
                <label>否&emsp;&emsp;<input type="radio" name="is_selected" id="optionsRadios2" value="0" checked>
                </label>
            </div>
        </div>
